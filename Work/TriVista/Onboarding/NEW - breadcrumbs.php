	...
	<?php
		...
		if ( function_exists( 'bcn_display' ) ) //this runs off the Breadcrumb NavXT plugin {
		{
			...
			if ( is_singular('leadership') ) {
				...
				echo ' &gt ';
				echo '<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Our Team." href="/about-us/ourteam/"><span property="name">Our Team</span></a><meta property="position" content="2"></span>';
				echo ' &gt ';
				echo '<span property="itemListElement" typeof="ListItem">'. single_post_title() .'</span><meta property="position" content="2"></span>';
