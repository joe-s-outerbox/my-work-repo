...
<header id="header">
    ...
    <div class="px-header">   
        ...
        ?>   
         <a class="contact-us-header mobileOnly" href="/contact-us">Contact Us</a>                           
        ...
        <nav class="main-nav" aria-label="Primary Navigation">
            ...
            <a class="contact-us-header desktopOnly" href="/contact-us">Contact Us</a>
        </nav><!-- #masthead -->     
    </div><!--/px-header -->    
    <div class="topPromo">
    ...
    <div class="mobileNav-login mobileOnly">
      <a href="http://tviq.trivista.com/" target="_blank" >TriVista Intelligence</a>
    </div>
