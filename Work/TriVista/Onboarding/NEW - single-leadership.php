...
* different template.
*
* OBX SEO Changes 6.14.23 - Div after about-body-section -> container changed from col-md-8 to col-md-12 for full display, 
* sidebar commented out below, changes to /inc/breadcrumbs.php
*()
...
?>
    ...
    <div class="banner" style="height: 675px !important;">
        <div style="background-position: center !important; background: url('<?php echo $thumb; ?>') no-repeat center center; " class="slide-img banner-bg-img">
        </div>
    </div>
    ...
    <div class="main-container">
        ...
        <section class="about-body-section">
            <div class="container">
                <div class="col-md-12 col-md-offset-1 col-sm-8 body-txt person-info pull-right test"> 
                ...
                <!-- OBX SEO changes - commented this out for full-width
