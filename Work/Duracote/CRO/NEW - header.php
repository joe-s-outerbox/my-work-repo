                    ...
                    <div class="row">
                        <div>
                            ...
                            <div id="contact">
                                ...
                                <ul>
                                    <li><a href="tel:+18003212252" aria-label="1 8 0 0. 3 2 1. 2 2 5 2.">TOLL FREE: (800) 321-2252</a></li>
                    ...
                    <div class="row addition">
                        ...
                        <div id="logo" class="four columns">
                            <a href="<?php echo get_home_url(); ?>">
                                <img src="https://www.duracote.com/wp-content/uploads/2022/04/Duracote-75-logo.svg" alt="Engineered Flexible Materials & Industrial Coatings Manufacturer - Duracote"/>
                            </a>
                        </div>

                        <div id="nav-search">
                            <div id="nav-flex-wrapper">
                                <div id="nav-flex-search-row" >
                                    <?php get_search_form() ?>
                                </div>
                                <nav id="main-nav">
                                    <?php
                        ...
                        <div class="two columns omega">
                            <a href="https://www.duracote.com/blog/as9100-certified-companies/"><img class="desktop-as-img" src="https://www.duracote.com/wp-content/uploads/2019/03/SQA-AS9100-2016.png" alt="AS 9100:2016 Certified in Smithers Quality Assessments."/></a>
                        </div>
                        </div>        
                    </div>
                </div>
